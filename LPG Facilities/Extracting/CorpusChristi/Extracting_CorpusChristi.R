#Extracting Corpus Christi starting mid 2018. 
# The coordinates 27.890013(LAT),-97.271692(LONG)). 
library(dplyr)
library(tidyverse)
library(utils)
...
lat_bounds <-  c(26.5, 29)
lon_bounds <- c(-98.5, -96)
...
#end date currently
end_date = as.Date("2023-07-18")


vnf.data.exist = file.exists(paste0(code.dir, "CC-vnf.rds"))

if(vnf.data.exist){
  vnf = readRDS(paste0(data.dir, "CC-vnf.rds"))
