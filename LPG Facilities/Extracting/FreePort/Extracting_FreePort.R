#Extracting Freeport
#started mid 2019
#coordinates -95.3271224, 28.9266713,
library(dplyr)
library(tidyverse)
library(utils)
...
lat_bounds <-  c(27.5, 30)
lon_bounds <- c(-96.5, -94)
...
vnf.data.exist = file.exists(paste0(code.dir, "FP-vnf.rds")) #change this line

if(vnf.data.exist){
  vnf = readRDS(paste0(data.dir, "FP-vnf.rds"))
